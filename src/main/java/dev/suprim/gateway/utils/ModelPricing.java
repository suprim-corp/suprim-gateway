...
public enum ModelPricing {
    ...
    ANTIGRAVITY_GEMINI_3_6_FLASH_LOW("gemini-3.6-flash-low", PricingTier.FLAT, 1.5, 7.5),
    ANTIGRAVITY_GEMINI_3_6_FLASH_MEDIUM("gemini-3.6-flash-medium", PricingTier.FLAT, 1.5, 7.5),
    ANTIGRAVITY_GEMINI_3_6_FLASH_HIGH("gemini-3.6-flash-high", PricingTier.FLAT, 1.5, 7.5),
    ANTIGRAVITY_GEMINI_3_6_FLASH_TIERED("gemini-3.6-flash-tiered", PricingTier.FLAT, 1.5, 7.5),
