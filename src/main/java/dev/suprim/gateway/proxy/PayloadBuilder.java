...
public class PayloadBuilder {
    ...
    public String buildOpenAiPayload(Map<String, Object> request, KiroAuthManager auth) throws Exception {
        ...
        if (!systemPrompt.isEmpty()) {
            ...
            ObjectNode primingAssistantMsg = primingAssistant.putObject("assistantResponseMessage");
        ...
        for (int i = 0; i < nonSystemMessages.size(); i++) {
            ...
            if ("user".equals(role)) {
                ...
                if (isLast) {
                    ...
                    userMsg.put("content", content != null && !content.isEmpty() ? content : ".");
                ...
                boolean nextIsTool = nextIdx < nonSystemMessages.size()
                                     && "tool".equals(nonSystemMessages.get(nextIdx).get("role"));
                ...
                if (!nextIsTool && !isLast) {
                    ...
                    for (Map<String, Object> tr : currentToolResults) {
                        ...
                        textObj.put("text", truncate(ContentExtractor.fromMessage(tr), MAX_TOOL_RESULT_CONTENT_LEN));
        ...
        boolean hasCurrentToolResults = currentToolResults != null && !currentToolResults.isEmpty();
